      ...
      <div className={Styles.aboutUs}>
        <div className={Styles.aboutus}>
          <div className={Styles.HeadPara}>
            <h1>About Us</h1>
            <p>
              We are a platform that bridges the gap between content creators
        ...
        <div className={Styles.WhySubtitle}>
          <div className={Styles.SubtitleLogo}>
            <img src={Subtitle} alt="AboutUs" />
          </div>
          <div className={Styles.SubPara}>
            <h2>Why Subtitles are Needed ?</h2>
            <p>
              Subtitles play a crucial role in making content accessible to a
